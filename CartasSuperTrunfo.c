...
int main()
{
    ...
    float area1, pib1, area2, pib2, densidade_populacional1, densidade_populacional2, pib_per_capita1, pib_per_capita2; // Adicionados a densidade populacional e o PIB per capita
